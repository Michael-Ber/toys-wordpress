                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-7 offset-1">
                                                ...
                                                style="
                                                <?php 
                                                    $field = get_field('slider-title_color');
                                                    if($field == 'white'){ ?>
                                                        color: #fff;
                                                    <?php
                                                    }
                    ...
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            <?php 
                                ...
                                <?php endif;
                                // print_r($image); //выводит информацию по массиву с img
                            ?>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('search_question'); ?></span> <?php the_field('search_answer'); ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php 
                                echo do_shortcode('[contact-form-7 id="166" title="Форма отзывов"]');
                            ?>
                        </div>
